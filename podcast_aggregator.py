...
# Handle empty string from GH Actions secrets if not set
...
def main():
    ...
    parser.add_argument("--days", type=int, default=1, help="Number of days to look back for updates")
    ...
    print(f"Checking for episodes since: {start_date} ({DAYS_TO_CHECK} days ago)")
